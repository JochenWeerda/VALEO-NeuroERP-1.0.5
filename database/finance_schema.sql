...
CREATE TABLE IF NOT EXISTS finanz.kreditoren_zahlungen (
    ...
    zahlungsreferenz VARCHAR(100),
    zahlungsinfo TEXT,
    status VARCHAR(50) DEFAULT 'Geplant' CHECK (status IN ('Geplant', 'Ausgeführt', 'Storniert')),
...
-- Standard-Kontenplan einfügen
INSERT INTO finanz.konten (kontonummer, kontobezeichnung, kontotyp, kontenklasse, kontengruppe) VALUES
('1000', 'Kasse', 'Aktiv', '1', 'Umlaufvermögen'),
('1200', 'Bankkonto', 'Aktiv', '1', 'Umlaufvermögen'),
('1400', 'Forderungen aus Lieferungen und Leistungen', 'Aktiv', '1', 'Umlaufvermögen'),
('1600', 'Vorsteuer', 'Aktiv', '1', 'Umlaufvermögen'),
('2000', 'Verbindlichkeiten aus Lieferungen und Leistungen', 'Passiv', '2', 'Kurzfristige Verbindlichkeiten'),
('2200', 'Verbindlichkeiten gegenüber Finanzämtern', 'Passiv', '2', 'Kurzfristige Verbindlichkeiten'),
('2400', 'Verbindlichkeiten gegenüber Sozialversicherung', 'Passiv', '2', 'Kurzfristige Verbindlichkeiten'),
('3000', 'Eigenkapital', 'Passiv', '3', 'Eigenkapital'),
('4000', 'Umsatzerlöse', 'Ertrag', '4', 'Erträge'),
