...
-- =====================================================
-- Erstellt: März 2024
-- Beschreibung: Vollständiges Lagerverwaltungs-System
-- L3-Konformität: LAGER, LAGERBEWEGUNGEN, LAGERPLAETZE
-- =====================================================

-- Schema für Lagerverwaltung erstellen
...
CREATE TABLE lager.chargen (
    ...
    verfallsdatum DATE,
    charge_status VARCHAR(20) DEFAULT 'VERFÜGBAR' CHECK (charge_status IN ('VERFÜGBAR', 'RESERVIERT', 'QUALITAET', 'GESPERRT', 'VERBRAUCHT')),
    qualitaetsstatus VARCHAR(20) DEFAULT 'FREIGEGEBEN' CHECK (qualitaetsstatus IN ('FREIGEGEBEN', 'IN_PRÜFUNG', 'GESPERRT', 'VERWORFEN')),
    bemerkung TEXT,
    erstellt_am TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    geaendert_am TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE lager.wareneingang (
    ...
    lagerort_id UUID NOT NULL REFERENCES lager.lagerorte(lagerort_id),
    status VARCHAR(20) DEFAULT 'ERWARTET' CHECK (status IN ('ERWARTET', 'ANGEKÜNDIGT', 'EINGETROFFEN', 'IN_BEARBEITUNG', 'ABGESCHLOSSEN', 'STORNIERT')),
...
CREATE TABLE lager.inventur_positionen (
    ...
    einheit VARCHAR(20) NOT NULL,
    inventur_status VARCHAR(20) DEFAULT 'OFFEN' CHECK (inventur_status IN ('OFFEN', 'GEPRÜFT', 'ABGESCHLOSSEN')),
    pruefer_id UUID,
...
-- =====================================================
-- 8. TRIGGER FÜR AUTOMATISCHE UPDATES
-- =====================================================
...
-- =====================================================
-- 9. FUNKTIONEN FÜR BERECHNUNGEN
-- =====================================================

-- Funktion für automatische Bewegungsnummern
...
-- Funktion für automatische Wareneingangsnummern
...
-- Funktion für automatische Warenausgangsnummern
...
-- Funktion für Bestandsberechnung
...
('LAG-001', 'Hauptlager München', 'HAUPTLAGER', 'München', 5000.0),
('LAG-002', 'Produktionslager', 'PRODUKTIONSLAGER', 'München', 2000.0),
('LAG-003', 'Qualitätslager', 'QUALITAETSLAGER', 'München', 500.0);
