...
-- Erweiterte Tabellen für vollständiges ERP-System
-- Version: 2.1
...
('TechCorp GmbH', 'Anna Schmidt', 'anna.schmidt@techcorp.de', '+49-30-123456', 'Musterstraße 123', 'Berlin', '10115', 'Germany', 'business', 'active'),
('Innovation Labs', 'Max Mustermann', 'max.mustermann@innovationlabs.de', '+49-89-654321', 'Innovationsweg 456', 'München', '80331', 'Germany', 'business', 'active'),
('StartupXYZ', 'Lisa Müller', 'lisa.mueller@startupxyz.de', '+49-40-789012', 'Startup-Allee 789', 'Hamburg', '20095', 'Germany', 'business', 'active')
ON CONFLICT DO NOTHING;

-- Views für erweiterte Berichte
