...
import { 
  Store as StoreIcon, Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Refresh as RefreshIcon} from '@mui/icons-material';
...
className="text-red-600"
      ...
      <Dialog open={editDialog,} onClose={() => setEditDialog(false),} maxWidth="lg" fullWidth>
        ...
        <DialogContent>
          {selectedOrder && (<div className="space-y-6 pt-2">, {/* Order Details */, }
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <TextField
                  label="Auftragsnummer"
                  value={selectedOrder.orderNumber, }
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, orderNumber: e.target.value
                  })}
                  fullWidth
                />
                <TextField
                  ...
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, customer: e.target.value
                  })}
                  fullWidth
                />
                <TextField
...
type="date"
                  ...
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, deliveryDate: e.target.value
                  })}
                  fullWidth
                />
                <TextField
                  ...
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, route: e.target.value
                  })}
                  fullWidth
                />
                <TextField
                  ...
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, driver: e.target.value
                  })}
                  fullWidth
                />
                <TextField
                  ...
                  onChange={(e) => setSelectedOrder({
                    ...selectedOrder, vehicle: e.target.value
                  })}
                  fullWidth
                />
              </div>
