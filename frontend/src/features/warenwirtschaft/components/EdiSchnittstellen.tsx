...
import { 
  Card, Typography, Button, Alert, Chip, IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TableRow} from '@mui/material';
import { 
  Send as SendIcon,
...
const [ediMessages] = useState([, {
      id: '1', typ: 'ORDERS', partner: 'Lieferant A', datum: new Date(),
      status: 'gesendet',
