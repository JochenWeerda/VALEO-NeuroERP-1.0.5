...
export const formatCurrency = (
  amount: number, currency: string = 'EUR', locale: string = 'de-DE'): string => {
...
export const formatDate = (
  date: Date | string | number, locale: string = 'de-DE', options?: Intl.DateTimeFormatOptions): string => {;
...
const defaultOptions: Intl.DateTimeFormatOptions = {
  ...
  return new Intl.DateTimeFormat(locale, {
    ...defaultOptions, ...options, }).format(dateObj);
};
...
export const formatDateTime = (
  date: Date | string | number, locale: string = 'de-DE'): string => {;
const dateObj = typeof date === 'string' || typeof date === 'number' ,
    ? new Date(date) ,
    : date;
...
export const formatNumber = (
  number: number, locale: string = 'de-DE'): string => {
...
export const formatPercentage = (
  value: number, locale: string = 'de-DE'): string => {
  return new Intl.NumberFormat(locale, {
