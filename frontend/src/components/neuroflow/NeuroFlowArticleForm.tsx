...
import {
  Save as SaveIcon, Cancel as CancelIcon, Refresh as RefreshIcon, Inventory as InventoryIcon, Category as CategoryIcon, Euro as EuroIcon, Scale as ScaleIcon, Settings as SettingsIcon, QrCode as BarcodeIcon, Description as DescriptionIcon, LocalShipping as ShippingIcon, Storage as StorageIcon} from '@mui/icons-material';
...
const ArticleSchema = z.object({
  // Grunddaten, article_number: z.string().min(1, 'Artikelnummer ist erforderlich'),
