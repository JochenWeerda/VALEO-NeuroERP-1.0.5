...
import {
  Box, Card, CardContent, Typography, TextField, Button, Grid, FormControl, InputLabel, Select, MenuItem, FormHelperText, Chip, Divider, Stack, IconButton, Tooltip, Skeleton, CircularProgress, Tabs, Tab, Alert} from '@mui/material';
import {
  Save as SaveIcon, Cancel as CancelIcon, Refresh as RefreshIcon, Person as PersonIcon, Business as BusinessIcon, Email as EmailIcon, Phone as PhoneIcon, LocationOn as LocationIcon, AccountBalance as BankIcon, Receipt as InvoiceIcon, Settings as SettingsIcon} from '@mui/icons-material';
...
const CustomerSchema = z.object({
  // Grunddaten, customer_number: z.string().min(1, 'Kundennummer ist erforderlich'),
