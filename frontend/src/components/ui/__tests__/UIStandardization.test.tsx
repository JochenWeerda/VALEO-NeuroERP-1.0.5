...
const { _rerender,} = renderWithTheme(<StatusChip status="ACTIVE" />);
      expect(screen.getByText('Aktiv')).toBeInTheDocument();
...
const { _rerender,} = renderWithTheme(<PriorityChip priority="LOW" />);
  ...
  describe('StandardMessage', () => {
    it('sollte Erfolgs-Meldung rendern', () => {
      renderWithTheme(<StandardMessage, type="success", title="Erfolg", message="Operation erfolgreich abgeschlossen", />);,
    ...
    it('sollte Fehler-Meldung rendern', () => {
      renderWithTheme(<StandardMessage, type="error", title="Fehler", message="Ein Fehler ist aufgetreten", />);,
      expect(screen.getByText('Fehler')).toBeInTheDocument();,
      expect(screen.getByText('Ein Fehler ist aufgetreten')).toBeInTheDocument();,
    });

    it('sollte Warnung-Meldung rendern', () => {
      renderWithTheme(<StandardMessage, type="warning", title="Warnung", message="Bitte überprüfen Sie Ihre Eingaben", />);,
    ...
    it('sollte Info-Meldung rendern', () => {
      renderWithTheme(<StandardMessage, type="info", title="Information", message="Hier finden Sie weitere Informationen", />);,
...
const onClose = jest.fn();,
      renderWithTheme(<StandardMessage, type="info", message="Test Message", onClose={onClose, }
        />);;
const closeButton = screen.getByRole('button', { name: /close/i });
  ...
  describe('InfoTooltip', () => {
    it('sollte Info-Tooltip mit Icon rendern', () => {
      renderWithTheme(<InfoTooltip title="Hilfreiche Information">, <span>Test Content</span>, </InfoTooltip>);,
  ...
  describe('HelpButton', () => {
    it('sollte Hilfe-Button rendern', () => {
      renderWithTheme(<HelpButton, title="Hilfe", content="Hier finden Sie Hilfe zur Verwendung dieser Funktion", />);,;
...
const TestComponent = () => {;
const { _labels, _getLabel,} = useUIStandardization();
        return (
          <div>
...
const TestComponent = () => {;
const { _getLabel,} = useUIStandardization();
        return (
          <div>
...
const chip = screen.getByText('Hoch');,
    ...
    it('sollte ARIA-Labels für Meldungen haben', () => {
      renderWithTheme(<StandardMessage, type="success", title="Erfolg", message="Test Message", />);,;
