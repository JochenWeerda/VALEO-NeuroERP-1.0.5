...
import {
  Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, FormControl, InputLabel, Select, MenuItem, FormControlLabel, Switch, Grid, Box, Typography, Chip, Alert} from '@mui/material';
...
interface ContactFormProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (formData: _ContactPersonFormData) => void;
...
export const ContactForm: React.FC<ContactFormProps> = ({
  open, onClose, onSubmit, contact = null, isLoading = false, error = null, }) => {;
...
const handleInputChange = (field: keyof ContactPersonFormData, value: unknown) => {
    setFormData(prev => ({
      ...prev, [field]: value
    }));
  };;
const handleContactScheduleChange = (weekday: string, contactTime: unknown) => {
    setFormData(prev => ({
      ...prev, contactSchedule: {
        ...prev.contactSchedule, [weekday]: contactTime
      }
    }));
  };;
