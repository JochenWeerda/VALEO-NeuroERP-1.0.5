...
import {
  Box, Typography, FormControlLabel, Switch, TextField, Grid, Paper, Divider} from '@mui/material';
...
const label = weekdayLabels[weekday];,
          ...
          return (<Grid item xs={12, } key={weekday, }>
              <Box
                sx={{
                  p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1, backgroundColor: contactTime.available ? 'action.hover' : 'background.paper'
                }}
              >
                <Box display="flex" alignItems="center" gap={2, } mb={1, }>
                  ...
                  <FormControlLabel
                    control={
                      <Switch, checked={contactTime.available, }
