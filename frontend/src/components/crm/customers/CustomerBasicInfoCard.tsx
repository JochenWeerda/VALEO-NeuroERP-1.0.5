...
export const CustomerBasicInfoCard: React.FC<CustomerBasicInfoCardProps> = ({
  ...
  return (<Card>, <CardContent>, <Box className="flex items-center mb-4">, <BusinessIcon className="mr-2 text-gray-600" />, <Typography variant="h6">Grunddaten</Typography>, </Box>, <Grid container spacing={2, }>
          <Grid item xs={12, }>
            <TextField
              fullWidth
              label="Firmenname"
