...
import { 
  Box, Typography, Card, CardContent, Tabs, Tab, Button} from '@mui/material';
...
const renderTabContent = () => {
    switch (activeTab) {
      case 0: // E-Mail
        return (<Box className="p-4">, <Typography variant="h6" className="mb-4 text-gray-800">, E-Mail-Historie - {customer.name, }
            </Typography>
