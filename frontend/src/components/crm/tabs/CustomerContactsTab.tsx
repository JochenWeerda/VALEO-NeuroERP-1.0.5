...
import {
  Box, Button, Typography, Alert, CircularProgress} from '@mui/material';
import { Add as AddIcon ,} from '@mui/icons-material';
import { Customer, ContactPerson, ContactPersonFormData} from '../../../types/crm';
import { 
  useContactPersons, useCreateContactPerson, useUpdateContactPerson, useDeleteContactPerson} from '../../../hooks/useCRM';
import { 
  mapApiContactToFormData, mapFormDataToApiContact} from '../../../types/crm';
...
const [editingContact, setEditingContact] = useState<ContactPersonFormData | null>(null);,
  ...
  // API Hooks,;
const { 
    data: contacts = [], _isLoading, _error, _refetch} = useContactPersons(customer.id);;
...
const contactId = contacts.find(c =>, c.firstName === editingContact.firstName &&, c.lastName === editingContact.lastName)?.id;,
