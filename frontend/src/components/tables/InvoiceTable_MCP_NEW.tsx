...
const renderRLSInfo = () => {
    ...
    return (<Card className="mb-4">, <CardContent>, <Typography variant="h6" className="flex items-center mb-2">, <InfoIcon className="mr-2" />, RLS-Compliance Status (MCP-Server),
          </Typography>,
          ...
          {!mcpTable.schema.rls.update && (<Alert severity="warning" className="mt-2">, <Typography variant="caption">, ⚠️ Rechnungen können nach dem Erstellen nicht mehr bearbeitet werden, </Typography>, </Alert>),}
        </CardContent>
      </Card>
    );
  };
