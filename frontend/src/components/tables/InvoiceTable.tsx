...
import {
  Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TablePagination, TableSortLabel, Chip, IconButton, Tooltip, Box, Typography, TextField, InputAdornment, FormControl, InputLabel, Select, MenuItem, Alert, CircularProgress} from '@mui/material';
import {
  Visibility as ViewIcon, Edit as EditIcon, Delete as DeleteIcon, Search as SearchIcon, FilterList as FilterIcon, Euro as EuroIcon, Person as PersonIcon, Assignment as AssignmentIcon} from '@mui/icons-material';
...
export const InvoiceTable: React.FC<InvoiceTableProps> = ({
  invoices, customers, isLoading = false, onView, onEdit, onDelete, }) => {;
...
const customer = customers.find(c => c.id === customerId);,
  ...
  return (<Paper className="shadow-lg">
      {/* Header */, }
...
className="flex-1"
      ...
      <TableContainer>
        <Table>
          ...
          <TableBody>
            {paginatedInvoices.length === 0 ? (<TableRow>, <TableCell colSpan={5, } align="center" className="py-8">
                  <Alert severity="info">
