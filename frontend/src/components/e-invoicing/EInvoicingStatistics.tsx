...
import {
  Card, CardContent, Typography, Grid, Box, LinearProgress, Chip} from '@mui/material';
import {
  TrendingUp, TrendingDown, AttachMoney, Receipt, Warning, CheckCircle} from '@mui/icons-material';
...
const getStatusIcon = (status: string) => {
  ...
  if (isLoading) {
    return (<Box className="w-full">, <LinearProgress />, <Typography className="mt-4 text-center text-gray-500">, Lade Statistiken..., </Typography>, </Box>);,
  }
