...
const crmForms = formRegistry.getFormsByModule('crm');,
  ...
  return (<div className="w-full">, <div className="mb-6">, <h2 className="text-2xl font-bold text-gray-900 mb-2">, CRM - {formRegistry.getForm(selectedForm)?.metadata.name || 'Formular',}
        </h2>
...
className={`p-3 rounded border cursor-pointer transition-colors ${
                selectedForm === form.id, ? 'bg-purple-50 border-purple-200 text-purple-800', : 'bg-white border-gray-200 hover:bg-gray-50'
              }`}
            >
