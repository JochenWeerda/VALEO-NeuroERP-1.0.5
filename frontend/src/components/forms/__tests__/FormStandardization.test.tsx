...
import {
  StandardTextField, StandardSelectField, StandardButton, FormActions, FormMessage, useFormValidation, FORM_LABELS} from '../FormStandardization';
...
describe('Form Standardization', () => {
  describe('StandardTextField', () => {
    it('sollte Textfeld mit Label rendern', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", />);,
      expect(screen.getByLabelText('Test Label')).toBeInTheDocument();,
    });

    it('sollte required Feld markieren', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", required, />);,;
const input = screen.getByLabelText('Test Label *');,
      expect(input).toBeInTheDocument();,
    });

    it('sollte placeholder anzeigen', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", placeholder="Test Placeholder", />);,
      expect(screen.getByPlaceholderText('Test Placeholder')).toBeInTheDocument();,
    });

    it('sollte helper text anzeigen', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", helperText="Helper Text", />);,
      expect(screen.getByText('Helper Text')).toBeInTheDocument();,
    });

    it('sollte disabled Feld rendern', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", disabled, />);,;
const input = screen.getByLabelText('Test Label');,
      expect(input).toBeDisabled();,
    });

    it('sollte multiline Feld rendern', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", multiline, rows={3, }
        />);;
const textarea = screen.getByLabelText('Test Label');
    ...
    it('sollte password Feld mit Toggle rendern', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Password", type="password", />);,;
...
const toggleButton = screen.getByRole('button');,
    ...
    it('sollte clear button anzeigen wenn aktiviert', () => {
      renderWithThemeAndForm(<StandardTextField, name="test", label="Test Label", showClearButton, />);,;
const input = screen.getByLabelText('Test Label');,
...
const clearButton = screen.getByRole('button');
  ...
  describe('StandardSelectField', () => {
    it('sollte Select-Feld mit Label rendern', () => {
      renderWithThemeAndForm(<StandardSelectField, name="test", label="Test Label", options={[, { value: 'option1', label: 'Option 1' }, { value: 'option2', label: 'Option 2' }
          ]}
        />);
      expect(screen.getByLabelText('Test Label')).toBeInTheDocument();
    });
    ...
    it('sollte required Select-Feld markieren', () => {
      renderWithThemeAndForm(<StandardSelectField, name="test", label="Test Label", required, options={[, { value: 'option1', label: 'Option 1' }
          ]}
        />);;
const select = screen.getByLabelText('Test Label *');
    ...
    it('sollte multiple Select-Feld rendern', () => {
      renderWithThemeAndForm(<StandardSelectField, name="test", label="Test Label", multiple, options={[, { value: 'option1', label: 'Option 1' }, { value: 'option2', label: 'Option 2' }
          ]}
        />);;
const select = screen.getByLabelText('Test Label');
      expect(select).toBeInTheDocument();
    ...
    it('sollte disabled Optionen rendern', () => {
      renderWithThemeAndForm(<StandardSelectField, name="test", label="Test Label", options={[, { value: 'option1', label: 'Option 1' }, { value: 'option2', label: 'Option 2', disabled: true }
          ]}
        />);;
const select = screen.getByLabelText('Test Label');
      expect(select).toBeInTheDocument();
...
const { _rerender,} = renderWithThemeAndForm(
...
const saveButton = screen.getByText('Speichern');
  ...
  describe('FormMessage', () => {
    it('sollte success Message rendern', () => {
      renderWithThemeAndForm(<FormMessage, type="success", title="Erfolg", message="Operation erfolgreich", />);,
    ...
    it('sollte error Message rendern', () => {
      renderWithThemeAndForm(<FormMessage, type="error", title="Fehler", message="Ein Fehler ist aufgetreten", />);,
      expect(screen.getByText('Fehler')).toBeInTheDocument();,
      expect(screen.getByText('Ein Fehler ist aufgetreten')).toBeInTheDocument();,
    });

    it('sollte warning Message rendern', () => {
      renderWithThemeAndForm(<FormMessage, type="warning", title="Warnung", message="Bitte überprüfen Sie Ihre Eingaben", />);,
    ...
    it('sollte info Message rendern', () => {
      renderWithThemeAndForm(<FormMessage, type="info", title="Information", message="Hier finden Sie weitere Informationen", />);,
...
const onClose = jest.fn();,
      renderWithThemeAndForm(<FormMessage, type="info", message="Test Message", onClose={onClose, }
        />);;
...
const validation = useFormValidation();,
        return (<div>, <span data-testid="has-errors">{validation.hasErrors.toString(),}</span>
  ...
  describe('Integration Tests', () => {
    it('sollte vollständiges Formular rendern', () => {
      renderWithThemeAndForm(<div>, <StandardTextField, name="name", label="Name", required, />, <StandardSelectField, name="status", label="Status", options={[, { value: 'active', label: 'Aktiv' }, { value: 'inactive', label: 'Inaktiv' }
            ]}
          />
          <FormActions
    ...
    it('sollte Formular-Validierung funktionieren', async () => {
      renderWithThemeAndForm(<div>, <StandardTextField, name="email", label="E-Mail", required, />, <FormActions onSave={() => {}} />
        </div>
      );;
