...
import { 
  Card, CardContent, Typography, Tabs, Tab, Box, Chip, Button, Dialog, DialogTitle, DialogContent, DialogActions, List, ListItem, ListItemText, ListItemIcon, Divider} from '@mui/material';
import {
  Warehouse as WarehouseIcon, AccountBalance as AccountBalanceIcon, People as PeopleIcon, Settings as SettingsIcon, Add as AddIcon, Edit as EditIcon, Visibility as ViewIcon, Delete as DeleteIcon} from '@mui/icons-material';
...
const [formStats, setFormStats] = useState({
    total: 0, byModule: {} as Record<string, number>, byStatus: {} as Record<string, number>
  });
...
const moduleCounts = formRegistry.getModuleCounts();,
    ...
    setFormStats({
      total: allForms.length, byModule: moduleCounts, byStatus: {
...
const openForm = (formId: string, mode: 'create' | 'edit' | 'view', data?: unknown) => {
