...
import { 
  AppBar, Toolbar, Typography, IconButton, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Avatar, Menu, MenuItem, Divider, Badge, Tooltip, Breadcrumbs, Link} from '@mui/material';
import {
  Menu as MenuIcon, Dashboard as DashboardIcon, Business as BusinessIcon, Inventory as InventoryIcon, Receipt as ReceiptIcon, Description as DocumentIcon, Analytics as AnalyticsIcon, People as PeopleIcon, ShoppingCart as SalesIcon, LocalShipping as WarehouseIcon, Build as ProductionIcon, AccountBalance as FinanceIcon, Assessment as QualityIcon, Assignment as ProjectIcon, Settings as SettingsIcon, Notifications as NotificationsIcon, AccountCircle as AccountCircleIcon, Logout as LogoutIcon, Help as HelpIcon, Home as HomeIcon, ChevronRight as ChevronRightIcon, AccountBalance as AccountBalanceIcon, LocalShipping as LocalShippingIcon, Assignment as AssignmentIcon, Build as BuildIcon, Assessment as AssessmentIcon} from '@mui/icons-material';
...
const { _user, _logout, _notifications,} = useApi();;
  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh', bgcolor: 'grey.50' }}>
      ...
      <AppBar 
        position="fixed" 
        sx={{ 
          zIndex: 50, bgcolor: 'background.paper', borderBottom: 1, borderColor: 'divider', boxShadow: 0
        }}
      >
        <Toolbar sx={{ px: 2 }}>
          <IconButton
...
variant="temporary"
      ...
      >
        ...
        {notifications.length > 5 && (<Box sx={{ px: 2, py: 1, borderTop: 1, borderColor: 'divider' }}>
            <Typography ;
variant="body2" 
              sx={{ 
                color: 'primary.main', cursor: 'pointer', '&:hover': { color: 'primary.dark' }
              }}
