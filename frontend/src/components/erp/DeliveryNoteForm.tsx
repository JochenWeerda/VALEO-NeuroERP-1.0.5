...
export const DeliveryNoteForm: React.FC<DeliveryNoteFormProps> = ({
  masterData, positions, suppliers, loading = false, error, onChangeMasterData, onChangePositions, onSubmit, onCancel, }) => {
...
const handleMasterChange = (field: keyof DeliveryNoteMasterData, value: unknown) => {
