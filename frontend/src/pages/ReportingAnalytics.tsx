...
import {
  Box, Card, CardContent, Typography, Grid, Tabs, Tab, Button, Chip, IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, LinearProgress, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, Switch, FormControlLabel, Alert, Tooltip, Fab} from '@mui/material';
import {
  Dashboard as DashboardIcon, Assessment as AssessmentIcon, Description as DescriptionIcon, GetApp as ExportIcon, Schedule as ScheduleIcon, TrendingUp as TrendingUpIcon, TrendingDown as TrendingDownIcon, Remove as NeutralIcon, Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Refresh as RefreshIcon, Download as DownloadIcon, Email as EmailIcon, Visibility as ViewIcon, Settings as SettingsIcon, BarChart as BarChartIcon, PieChart as PieChartIcon, TableChart as TableChartIcon, Timeline as TimelineIcon, FilterList as FilterIcon, Search as SearchIcon, Notifications as NotificationsIcon, Speed as SpeedIcon} from '@mui/icons-material';
