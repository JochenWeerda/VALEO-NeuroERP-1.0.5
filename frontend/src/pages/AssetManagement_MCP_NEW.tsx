  ...
  const assets: Asset[] = [
    {
      ...
      bezeichnung: 'Produktionsmaschine A',
  ...
  const vehicles: Vehicle[] = [
    {
      ...
      anzahl_wartungen: 2,
      naechste_wartung: '2024-03-01',
      erstellt_am: '2023-03-01T10:00:00Z',
      aktualisiert_am: '2024-01-15T10:00:00Z',
  ...
  const maintenance: Maintenance[] = [
    {
      ...
      anlagennummer: 'ANL-001',
      anlagenbezeichnung: 'Produktionsmaschine A',
      wartungstyp: 'planmaessig',
      geplantes_datum: '2024-02-15',
      status: 'geplant',
      prioritaet: 'mittel',
      verantwortlicher: 'Techniker Team',
      kosten: 500,
