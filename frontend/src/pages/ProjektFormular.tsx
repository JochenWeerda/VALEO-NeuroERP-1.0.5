...
import {
  Box, Card, Typography, Button, Tabs, Tab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Chip, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, Grid, Avatar, Tooltip, Alert, Snackbar, Divider, List, ListItem, ListItemText, ListItemAvatar, Accordion, AccordionSummary, AccordionDetails, Rating, Badge, LinearProgress, CardContent} from '@mui/material';
import {
  Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as ViewIcon, Assignment as ProjectIcon, Task as TaskIcon, People as PeopleIcon, Schedule as ScheduleIcon, ExpandMore as ExpandMoreIcon, TrendingUp as TrendingIcon, Warning as WarningIcon, CheckCircle as CheckIcon, Error as ErrorIcon, Info as InfoIcon, BarChart as ChartIcon, CalendarToday as CalendarIcon, AttachMoney as MoneyIcon, Flag as FlagIcon} from '@mui/icons-material';;
...
const [projekte, setProjekte] = useState<Projekt[]>([
    {
      id: '1', name: 'Website-Relaunch', beschreibung: 'Kompletter Relaunch der Unternehmenswebsite', kunde: 'TechCorp GmbH', projektleiter: 'Max Mustermann', startDatum: '2024-01-15', endDatum: '2024-03-15', status: 'aktiv', prioritaet: 'hoch', budget: 25000, verbraucht: 18500, fortschritt: 65, erstelltAm: '2024-01-10'
    }, {
      id: '2', name: 'ERP-Integration', beschreibung: 'Integration neuer ERP-Module', kunde: 'Industrie AG', projektleiter: 'Anna Schmidt', startDatum: '2024-02-01', endDatum: '2024-06-30', status: 'planung', prioritaet: 'mittel', budget: 50000, verbraucht: 0, fortschritt: 15, erstelltAm: '2024-01-20'
    }, {
      id: '3', name: 'Mobile App Entwicklung', beschreibung: 'Entwicklung einer mobilen App für Kunden', kunde: 'Startup GmbH', projektleiter: 'Tom Weber', startDatum: '2024-01-01', endDatum: '2024-04-30', status: 'aktiv', prioritaet: 'kritisch', budget: 35000, verbraucht: 28000, fortschritt: 80, erstelltAm: '2023-12-15'
    }
  ]);;
const [aufgaben, setAufgaben] = useState<Aufgabe[]>([
    {
      id: '1', projektId: '1', projektName: 'Website-Relaunch', name: 'Design-Entwürfe erstellen', beschreibung: 'Erstellung von Design-Mockups für die neue Website', zugewiesenAn: 'Lisa Müller', startDatum: '2024-01-15', endDatum: '2024-01-25', status: 'abgeschlossen', prioritaet: 'hoch', geschaetzteStunden: 40, verbrauchteStunden: 38, erstelltAm: '2024-01-15'
    }, {
      id: '2', projektId: '1', projektName: 'Website-Relaunch', name: 'Frontend-Entwicklung', beschreibung: 'Implementierung der Frontend-Komponenten', zugewiesenAn: 'Hans Klein', startDatum: '2024-01-26', endDatum: '2024-02-15', status: 'in_bearbeitung', prioritaet: 'hoch', geschaetzteStunden: 80, verbrauchteStunden: 45, erstelltAm: '2024-01-20'
    }, {
      id: '3', projektId: '3', projektName: 'Mobile App Entwicklung', name: 'API-Entwicklung', beschreibung: 'Entwicklung der Backend-APIs für die App', zugewiesenAn: 'Peter Schulz', startDatum: '2024-01-01', endDatum: '2024-02-15', status: 'abgeschlossen', prioritaet: 'kritisch', geschaetzteStunden: 120, verbrauchteStunden: 115, erstelltAm: '2024-01-01'
    }
  ]);;
const [ressourcen, setRessourcen] = useState<Ressource[]>([
    {
      id: '1', name: 'Max Mustermann', typ: 'mitarbeiter', verfuegbarkeit: 40, kostenProStunde: 85, abteilung: 'Entwicklung', skills: ['React', 'TypeScript', 'Node.js', 'Projektmanagement'], status: 'ausgelastet', email: 'max.mustermann@firma.de', telefon: '+49 123 456789'
    }, {
      id: '2', name: 'Anna Schmidt', typ: 'mitarbeiter', verfuegbarkeit: 35, kostenProStunde: 75, abteilung: 'Design', skills: ['UI/UX Design', 'Figma', 'Adobe Creative Suite'], status: 'verfuegbar', email: 'anna.schmidt@firma.de', telefon: '+49 123 456790'
    }, {
      id: '3', name: 'Entwicklungsserver', typ: 'ausstattung', verfuegbarkeit: 168, kostenProStunde: 2.5, abteilung: 'IT', skills: ['Linux', 'Docker', 'AWS'], status: 'verfuegbar', email: '', telefon: ''
    }
  ]);;
const [zeiterfassung, setZeiterfassung] = useState<Zeiterfassung[]>([
    {
      id: '1', mitarbeiterId: '1', mitarbeiterName: 'Max Mustermann', projektId: '1', projektName: 'Website-Relaunch', aufgabeId: '2', aufgabeName: 'Frontend-Entwicklung', datum: '2024-01-20', startZeit: '09:00', endZeit: '17:00', stunden: 8, beschreibung: 'Entwicklung der React-Komponenten', status: 'genehmigt', erstelltAm: '2024-01-20'
    }, {
      id: '2', mitarbeiterId: '2', mitarbeiterName: 'Anna Schmidt', projektId: '1', projektName: 'Website-Relaunch', aufgabeId: '1', aufgabeName: 'Design-Entwürfe erstellen', datum: '2024-01-19', startZeit: '08:30', endZeit: '16:30', stunden: 8, beschreibung: 'Finalisierung der Design-Mockups', status: 'genehmigt', erstelltAm: '2024-01-19'
    }, {
      id: '3', mitarbeiterId: '1', mitarbeiterName: 'Max Mustermann', projektId: '3', projektName: 'Mobile App Entwicklung', datum: '2024-01-18', startZeit: '10:00', endZeit: '18:00', stunden: 8, beschreibung: 'Code-Review und Bugfixes', status: 'offen', erstelltAm: '2024-01-18'
    }
  ]);;
const [projektForm, setProjektForm] = useState<Partial<Projekt>>({
    name: '', beschreibung: '', kunde: '', projektleiter: '', startDatum: new Date().toISOString().split('T')[0],
    endDatum: '',
    status: 'planung',
    prioritaet: 'mittel',
    budget: 0,
...
const handleSaveProjekt = () => {
    if (selectedProjekt) {
      ...
      setProjekte(projekte.map(p =>, p.id === selectedProjekt.id, ? { ...projektForm, id: p.id, erstelltAm: p.erstelltAm } as Projekt
          : p));
      setSnackbar({
        open: true, message: 'Projekt erfolgreich aktualisiert', severity: 'success'
      });
    } else {
      // Create new project,;
const newProjekt: Projekt = {
      ...
      setSnackbar({
        open: true, message: 'Projekt erfolgreich erstellt', severity: 'success'
      });
    }
    handleCloseDialog();
  };;
const handleDeleteProjekt = (id: string) => {
    ...
    setSnackbar({
      open: true, message: 'Projekt erfolgreich gelöscht', severity: 'success'
    });
  };;
...
variant="outlined" 
        ...
        <TabPanel value={tabValue,} index={2,}>
          <Grid container spacing={3,}>
            {ressourcen.map((ressource) => (<Grid item xs={12, } md={6, } lg={4, } key={ressource.id, }>
                <Card sx={{ p: 2, height: '100%' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
