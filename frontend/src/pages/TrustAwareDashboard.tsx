...
import { 
  Box, Typography, Card, Alert, Chip, CircularProgress, Button} from '@mui/material';
import { 
...
const [systemTrust] = useState<SystemTrust>({
    overall: 85, dataIntegrity: 92, aiAccuracy: 78, userTrust: 88, compliance: 95
  });;
...
const getStatusColor = (status: string) => {
  ...
  return (
    <Box 
      data-testid="trust-dashboard-container"
      sx={{ p: 3 }}
    >
