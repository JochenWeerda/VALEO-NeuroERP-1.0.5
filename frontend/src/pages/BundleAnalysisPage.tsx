    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Box component="pre" sx={{ 
          backgroundColor: 'grey.100', p: 2, borderRadius: 1, overflow: 'auto', fontSize: '0.875rem'
        }}>
{`# Bundle-Analyse mit Visualisierung, npm run build:analysis

# Bundle-Analyse öffnen, npm run analyze, # Production-Build ohne Analyse, npm run build:prod
