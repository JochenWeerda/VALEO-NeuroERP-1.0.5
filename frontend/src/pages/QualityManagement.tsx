...
import {
  Box, Card, CardContent, Typography, Grid, Chip, IconButton, Fab, Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Tabs, Tab, LinearProgress, Avatar, Alert, Badge, FormControl, InputLabel, Select, MenuItem, Switch, FormControlLabel} from '@mui/material';
import {
  Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as ViewIcon, CheckCircle as CheckCircleIcon, Warning as WarningIcon, Error as ErrorIcon, Science as ScienceIcon, Assignment as AssignmentIcon, Build as BuildIcon, Description as DescriptionIcon, Verified as VerifiedIcon, Timeline as TimelineIcon, Assessment as AssessmentIcon, Settings as SettingsIcon, CalendarToday as CalendarIcon, TrendingUp as TrendingUpIcon, BugReport as BugReportIcon, Security as SecurityIcon, School as SchoolIcon} from '@mui/icons-material';;
          ...
          <Table>
            ...
            <TableBody>
              {audits.map((audit) => (<TableRow key={audit.id, }>
                  ...
                  <TableCell>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      {[...Array(5)].map((_, index) => (<CheckCircleIcon, key={index, }
                          sx={{ 
                            color: index < audit.bewertung ? 'gold' : 'grey.300', fontSize: 16
                          }} 
                        />))}
                    </Box>
                  </TableCell>
