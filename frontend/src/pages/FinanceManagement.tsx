...
import {
  Box, Typography, Card, CardContent, Grid, Tabs, Tab, Button, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Chip, IconButton, Alert, CircularProgress, Divider, List, ListItem, ListItemText, ListItemSecondaryAction, Switch, Accordion, AccordionSummary, AccordionDetails} from '@mui/material';
import {
  AccountBalance as AccountBalanceIcon, Receipt as ReceiptIcon, Payment as PaymentIcon, TrendingUp as TrendingUpIcon, Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as ViewIcon, ExpandMore as ExpandMoreIcon, Euro as EuroIcon, AccountCircle as AccountCircleIcon, Business as BusinessIcon, LocalAtm as LocalAtmIcon, Assessment as AssessmentIcon} from '@mui/icons-material';
...
const [accountForm, setAccountForm] = useState({
    kontonummer: '', kontobezeichnung: '', kontotyp: 'Aktiv' as const, kontenklasse: '', kontengruppe: '', ist_aktiv: true
  });;
const [bookingForm, setBookingForm] = useState({
    buchungsdatum: '', belegnummer: '', buchungstext: '', sollkonto: '', habenkonto: '', betrag: '', waehrung: 'EUR'
  });
...
const newAccount: Account = {
      ...
      setAccountForm({
        kontonummer: '', kontobezeichnung: '', kontotyp: 'Aktiv', kontenklasse: '', kontengruppe: '', ist_aktiv: true
      });
    } catch (err) {
