...
import {
  Box, Typography, Card, CardContent, Grid, TextField, Button, FormControl, InputLabel, Select, MenuItem, Chip, Alert, Snackbar, Dialog, DialogTitle, DialogContent, DialogActions, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Tooltip, Stepper, Step, StepLabel, StepContent, Accordion, AccordionSummary, AccordionDetails, Divider, List, ListItem, ListItemText, ListItemIcon, Checkbox, Radio, RadioGroup, FormControlLabel, FormGroup, Switch, Slider, Rating, Autocomplete, CircularProgress, LinearProgress, Badge, Avatar, Tabs, Tab, Fab, SpeedDial, SpeedDialAction, SpeedDialIcon, Breadcrumbs, Link, Pagination, Skeleton, Backdrop, Modal, Fade, Grow, Slide, Zoom, Collapse, ListItemButton, ListItemAvatar, ListSubheader, ListItemSecondaryAction, InputAdornment, OutlinedInput, FilledInput, InputBase, FormLabel, FormHelperText} from '@mui/material';
import {
  Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Save as SaveIcon, Cancel as CancelIcon, Search as SearchIcon, FilterList as FilterIcon, Sort as SortIcon, Refresh as RefreshIcon, Download as DownloadIcon, Upload as UploadIcon, Print as PrintIcon, Share as ShareIcon, Visibility as VisibilityIcon, VisibilityOff as VisibilityOffIcon, ExpandMore as ExpandMoreIcon, ExpandLess as ExpandLessIcon, KeyboardArrowRight as ArrowRightIcon, KeyboardArrowLeft as ArrowLeftIcon, KeyboardArrowUp as ArrowUpIcon, KeyboardArrowDown as ArrowDownIcon, Check as CheckIcon, Close as CloseIcon, Warning as WarningIcon, Error as ErrorIcon, Info as InfoIcon, Help as HelpIcon, Settings as SettingsIcon, Notifications as NotificationsIcon, AccountCircle as AccountCircleIcon, Business as BusinessIcon, Inventory as InventoryIcon, LocalShipping as LocalShippingIcon, Store as StoreIcon, ShoppingCart as ShoppingCartIcon, Receipt as ReceiptIcon, Assessment as AssessmentIcon, TrendingUp as TrendingUpIcon, TrendingDown as TrendingDownIcon, Timeline as TimelineIcon, BarChart as BarChartIcon, PieChart as PieChartIcon, ShowChart as ShowChartIcon, InsertChart as InsertChartIcon, Analytics as AnalyticsIcon, DataUsage as DataUsageIcon, Storage as StorageIcon, Cloud as CloudIcon, CloudUpload as CloudUploadIcon, CloudDownload as CloudDownloadIcon, Sync as SyncIcon, Autorenew as AutorenewIcon, Loop as LoopIcon, RotateRight as RotateRightIcon, RotateLeft as RotateLeftIcon, Flip as FlipIcon, Transform as TransformIcon, Crop as CropIcon, CropFree as CropFreeIcon, CropSquare as CropSquareIcon, Crop169 as Crop169Icon, Crop32 as Crop32Icon, Crop54 as Crop54Icon, Crop75 as Crop75Icon, CropDin as CropDinIcon, CropOriginal as CropOriginalIcon, CropPortrait as CropPortraitIcon, CropLandscape as CropLandscapeIcon, CropRotate as CropRotateIcon, CropSquare as CropSquareIcon2, Crop169 as Crop169Icon2, Crop32 as Crop32Icon2, Crop54 as Crop54Icon2, Crop75 as Crop75Icon2, CropDin as CropDinIcon2, CropOriginal as CropOriginalIcon2, CropPortrait as CropPortraitIcon2, CropLandscape as CropLandscapeIcon2, CropRotate as CropRotateIcon2, // Zusätzliche Icons für Warenwirtschaft, ShoppingCart as BestellungIcon, LocalShipping as WareneingangIcon, Receipt as RechnungIcon, Inventory as LagerIcon, Inventory2 as Inventory2Icon, Visibility as ViewIcon, Flag as FlagIcon, AttachMoney as MoneyIcon} from '@mui/icons-material';
...
const [bestellungen, setBestellungen] = useState<Bestellung[]>([
    {
      id: '1', bestellnummer: 'BEST-2024-001', lieferant: 'Schrauben GmbH', bestelldatum: '2024-01-15', erwartetesLieferdatum: '2024-01-25', status: 'bestellt', gesamtbetrag: 1250.00, mwst: 237.50, endbetrag: 1487.50, besteller: 'Max Mustermann', notizen: 'Dringend benötigt für Projekt A', positionen: [
        {
          id: '1', artikelnummer: 'SCHR-001', bezeichnung: 'Industrie-Schraube M8x20', bestellmenge: 1000, gelieferteMenge: 0, einzelpreis: 0.85, gesamtpreis: 850.00, mwst: 19, status: 'offen'
        }, {
          id: '2', artikelnummer: 'SCHR-002', bezeichnung: 'Industrie-Schraube M10x25', bestellmenge: 500, gelieferteMenge: 0, einzelpreis: 0.80, gesamtpreis: 400.00, mwst: 19, status: 'offen'
        }
      ]
    }
  ]);;
const [wareneingaenge, setWareneingaenge] = useState<Wareneingang[]>([
    {
      id: '1', wareneingangsnummer: 'WE-2024-001', bestellnummer: 'BEST-2024-001', lieferant: 'Schrauben GmbH', lieferdatum: '2024-01-20', status: 'eingetroffen', lkwNummer: 'M-AB 1234', chauffeur: 'Hans Müller', notizen: 'Ware in gutem Zustand eingetroffen', positionen: [
        {
          id: '1', artikelnummer: 'SCHR-001', bezeichnung: 'Industrie-Schraube M8x20', bestellmenge: 1000, gelieferteMenge: 1000, gepruefteMenge: 980, mangelhafteMenge: 20, einzelpreis: 0.85, status: 'geprueft'
        }
      ]
    }
  ]);;
const [rechnungen, setRechnungen] = useState<Rechnung[]>([
    {
      id: '1', rechnungsnummer: 'RE-2024-001', lieferant: 'Schrauben GmbH', rechnungsdatum: '2024-01-20', faelligkeitsdatum: '2024-02-19', status: 'eingegangen', rechnungsbetrag: 1250.00, mwst: 237.50, endbetrag: 1487.50, zahlungsbedingungen: '30 Tage netto', notizen: 'Rechnung zur Bestellung BEST-2024-001', positionen: [
        {
          id: '1', artikelnummer: 'SCHR-001', bezeichnung: 'Industrie-Schraube M8x20', menge: 1000, einzelpreis: 0.85, gesamtpreis: 850.00, mwst: 19, bestellnummer: 'BEST-2024-001', wareneingangsnummer: 'WE-2024-001'
        }
      ]
    }
  ]);;
const [lagerbuchungen, setLagerbuchungen] = useState<Lagerbuchung[]>([
    {
      id: '1', buchungsnummer: 'LB-2024-001', buchungsdatum: '2024-01-20', buchungstyp: 'eingang', artikelnummer: 'SCHR-001', bezeichnung: 'Industrie-Schraube M8x20', menge: 980, lagerort: 'Lager A, Regal 1', kostenstelle: 'KST-001', belegnummer: 'WE-2024-001', notizen: 'Wareneingang von Schrauben GmbH', buchungsgrund: 'Wareneingang'
    }
  ]);;
const [lagerbestaende, setLagerbestaende] = useState<Lagerbestand[]>([
    {
      artikelnummer: 'SCHR-001', bezeichnung: 'Industrie-Schraube M8x20', lagerort: 'Lager A, Regal 1', aktuellerBestand: 1980, mindestbestand: 100, maximalbestand: 5000, reserviert: 200, verfuegbar: 1780, durchschnittspreis: 0.85, gesamtwert: 1683.00, letzteBewegung: '2024-01-20', status: 'normal'
    }
  ]);;
const handleTabChange = (event: React.SyntheticEvent, newValue: number) => {
    setTabValue(newValue);,
  };;
const handleOpenDialog = (item?: unknown) => {
                ...
                {lagerbestaende.map((bestand) => (<TableRow key={bestand.artikelnummer, }>
                    ...
                    <TableCell>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        {bestand.status === 'niedrig' && (, <LinearProgress, variant="determinate", value={(bestand.aktuellerBestand / bestand.mindestbestand) * 100,}
                            color="warning"
