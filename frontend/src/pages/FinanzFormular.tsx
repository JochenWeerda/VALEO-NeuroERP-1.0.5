...
import {
  Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as ViewIcon, AccountBalance as AccountIcon, Receipt as ReceiptIcon, TrendingUp as TrendingIcon, ExpandMore as ExpandMoreIcon, AttachMoney as MoneyIcon, LocalOffer as OfferIcon, Warning as WarningIcon, CheckCircle as CheckIcon, Error as ErrorIcon, Info as InfoIcon, BarChart as ChartIcon, AccountBalanceWallet as WalletIcon, CreditCard as CreditCardIcon, Savings as SavingsIcon} from '@mui/icons-material';;
...
const [buchungen, setBuchungen] = useState<Buchung[]>([
    {
      id: '1', datum: '2024-01-20', beschreibung: 'Einkauf Büromaterial', betrag: 245.50, typ: 'ausgabe', kategorie: 'Bürobedarf', konto: 'Bankkonto', belegnummer: 'RE-2024-001', status: 'bezahlt', mwst: 19, buchungstext: 'Büromaterial für Verwaltung', erstelltAm: '2024-01-20'
    }, {
      id: '2', datum: '2024-01-19', beschreibung: 'Kundenzahlung', betrag: 1250.00, typ: 'einnahme', kategorie: 'Umsatzerlöse', konto: 'Bankkonto', belegnummer: 'RE-2024-002', status: 'bezahlt', mwst: 19, buchungstext: 'Zahlungseingang Kunde Müller GmbH', erstelltAm: '2024-01-19'
    }, {
      id: '3', datum: '2024-01-18', beschreibung: 'Mietzahlung Büro', betrag: 850.00, typ: 'ausgabe', kategorie: 'Miete', konto: 'Bankkonto', belegnummer: 'RE-2024-003', status: 'offen', mwst: 19, buchungstext: 'Monatliche Mietzahlung', erstelltAm: '2024-01-18'
    }
  ]);;
const [konten, setKonten] = useState<Konto[]>([
    {
      id: '1', kontonummer: '1000', name: 'Bankkonto', typ: 'aktiv', saldo: 15420.50, waehrung: 'EUR', status: 'aktiv', beschreibung: 'Hauptbankkonto der Firma', erstelltAm: '2024-01-01'
    }, {
      id: '2', kontonummer: '1200', name: 'Forderungen', typ: 'aktiv', saldo: 3250.00, waehrung: 'EUR', status: 'aktiv', beschreibung: 'Offene Forderungen aus Lieferungen', erstelltAm: '2024-01-01'
    }, {
      id: '3', kontonummer: '4000', name: 'Umsatzerlöse', typ: 'ertrag', saldo: 45680.00, waehrung: 'EUR', status: 'aktiv', beschreibung: 'Erlöse aus Verkäufen', erstelltAm: '2024-01-01'
    }, {
      id: '4', kontonummer: '5000', name: 'Materialaufwand', typ: 'aufwand', saldo: 12350.00, waehrung: 'EUR', status: 'aktiv', beschreibung: 'Aufwand für Materialien', erstelltAm: '2024-01-01'
    }
  ]);;
const [berichte, setBerichte] = useState<Bericht[]>([
    {
      id: '1', name: 'Gewinn- und Verlustrechnung Q4 2023', typ: 'guv', zeitraum: 'Q4 2023', erstelltAm: '2024-01-15', status: 'erstellt', dateiUrl: '/reports/guv-q4-2023.pdf'
    }, {
      id: '2', name: 'Bilanz 31.12.2023', typ: 'bilanz', zeitraum: '31.12.2023', erstelltAm: '2024-01-10', status: 'erstellt', dateiUrl: '/reports/bilanz-2023.pdf'
    }, {
      id: '3', name: 'Cashflow-Analyse Januar 2024', typ: 'cashflow', zeitraum: 'Januar 2024', erstelltAm: '2024-01-20', status: 'in_bearbeitung'
    }
  ]);;
const [budgets, setBudgets] = useState<Budget[]>([
    {
      id: '1', name: 'Marketing Budget 2024', kategorie: 'Marketing', jahr: 2024, budgetBetrag: 15000, verbraucht: 8500, verbleibend: 6500, status: 'im_budget', beschreibung: 'Jahresbudget für Marketingaktivitäten'
    }, {
      id: '2', name: 'IT-Ausstattung 2024', kategorie: 'IT', jahr: 2024, budgetBetrag: 8000, verbraucht: 9200, verbleibend: -1200, status: 'ueber_budget', beschreibung: 'Budget für IT-Hardware und Software'
    }, {
      id: '3', name: 'Bürobedarf 2024', kategorie: 'Bürobedarf', jahr: 2024, budgetBetrag: 3000, verbraucht: 1800, verbleibend: 1200, status: 'unter_budget', beschreibung: 'Jahresbudget für Büromaterial'
    }
  ]);;
...
const handleSaveBuchung = () => {
    if (selectedBuchung) {
      ...
      setBuchungen(buchungen.map(b =>, b.id === selectedBuchung.id, ? { ...buchungForm, id: b.id, erstelltAm: b.erstelltAm } as Buchung
          : b));
      setSnackbar({
        open: true, message: 'Buchung erfolgreich aktualisiert', severity: 'success'
      });
    } else {
      // Create new booking,;
const newBuchung: Buchung = {
      ...
      setSnackbar({
        open: true, message: 'Buchung erfolgreich erstellt', severity: 'success'
      });
    }
    handleCloseDialog();
  };;
const handleDeleteBuchung = (id: string) => {
    ...
    setSnackbar({
      open: true, message: 'Buchung erfolgreich gelöscht', severity: 'success'
    });
  };;
          ...
          <Grid container spacing={3,}>
            {berichte.map((bericht) => (<Grid item xs={12, } md={6, } lg={4, } key={bericht.id, }>
                <Card sx={{ p: 2, height: '100%' }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 1 }}>
                    {bericht.status === 'erstellt' && (<Button size="small" variant="contained">, Herunterladen, </Button>),}
                    <Button size="small" variant="outlined">
                      Bearbeiten
                    </Button>
                  </Box>
