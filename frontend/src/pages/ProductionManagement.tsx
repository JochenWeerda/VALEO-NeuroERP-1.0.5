...
import {
  Box, Card, CardContent, Typography, Button, Tabs, Tab, Chip, LinearProgress, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Alert, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, IconButton, Tooltip} from '@mui/material';
import {
  Build as BuildIcon, Inventory as InventoryIcon, Assignment as AssignmentIcon, Engineering as EngineeringIcon, Verified as VerifiedIcon, Schedule as ScheduleIcon, Assessment as AssessmentIcon, Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as VisibilityIcon} from '@mui/icons-material';
  ...
  return (
    <Card className="h-full hover:shadow-lg transition-shadow">
      <CardContent>
        ...
        {subtitle && (<Typography variant="body2" color="textSecondary" className="mb-2">, {subtitle, }
          </Typography>)}
        {trend && (<Box className="flex items-center">, <Typography, variant="body2", className={`font-medium ${trend.isPositive ? 'text-green-600' : 'text-red-600'}`}
            >
...
className="flex items-center"
        ...
        <CardContent className="p-0">
          ...
          {activeTab === 0 && (<Box className="p-6">, <Box className="flex justify-between items-center mb-4">, <Typography variant="h6" className="font-semibold">, Produktionsaufträge, </Typography>, <Button, variant="contained", startIcon={<AddIcon />, }
...
className={getPriorityColor(auftrag.prioritaet),}
          ...
          {/* Stücklisten Tab */,}
          {activeTab === 1 && (<Box className="p-6">, <Box className="flex justify-between items-center mb-4">, <Typography variant="h6" className="font-semibold">, Stücklisten, </Typography>, <Button, variant="contained", startIcon={<AddIcon />, }
          ...
          {/* Arbeitspläne Tab */,}
          {activeTab === 2 && (<Box className="p-6">, <Box className="flex justify-between items-center mb-4">, <Typography variant="h6" className="font-semibold">, Arbeitspläne, </Typography>, <Button, variant="contained", startIcon={<AddIcon />, }
          ...
          {activeTab === 3 && (<Box className="p-6">, <Typography variant="h6" className="font-semibold mb-4">, Maschinenbelegung, </Typography>, <TableContainer component={Paper, }>
                <Table>
                  <TableHead>
                    <TableRow>
                  ...
                  <TableBody>
                    {mockMaschinenauslastung.map((maschine) => (<TableRow key={maschine.maschinen_nr, } hover>
                        ...
                        <TableCell>
                          {maschine.naechste_wartung, ? new Date(maschine.naechste_wartung).toLocaleDateString('de-DE'),
                            : '-'
                          }
                        </TableCell>
                        <TableCell align="center">
          ...
          {activeTab === 4 && (<Box className="p-6">, <Typography variant="h6" className="font-semibold mb-4">, Qualitätskontrolle, </Typography>, <Box className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="h-full">, <CardContent>, <Typography variant="h6" className="font-semibold mb-3">, Aktuelle Prüfungen, </Typography>, <Alert severity="info" className="mb-3">, 3 offene Qualitätsprüfungen, </Alert>, <Button variant="outlined" startIcon={<AddIcon />, } fullWidth>
          ...
          {/* Statistiken Tab */,}
          {activeTab === 5 && (<Box className="p-6">, <Typography variant="h6" className="font-semibold mb-4">, Produktionsstatistiken, </Typography>, <Box className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>, <CardContent>, <Typography variant="h6" className="font-semibold mb-3">, Qualitätsentwicklung, </Typography>, <TableContainer>, <Table size="small">, <TableHead>, <TableRow>, <TableCell>Monat</TableCell>, <TableCell align="right">Prüfungen</TableCell>, <TableCell align="right">Quote</TableCell>, </TableRow>, </TableHead>, <TableBody>, {mockQualitaetsstatistiken.map((stat) => (<TableRow key={stat.monat, }>
