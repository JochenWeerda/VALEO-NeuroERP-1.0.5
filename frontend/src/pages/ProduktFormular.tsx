...
import {
  Box, Card, Typography, Button, Tabs, Tab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Chip, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, TextField, FormControl, InputLabel, Select, MenuItem, Grid, Avatar, Tooltip, Alert, Snackbar, Divider, List, ListItem, ListItemText, ListItemAvatar, Accordion, AccordionSummary, AccordionDetails, Rating, Badge} from '@mui/material';
import {
  Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Visibility as ViewIcon, Category as CategoryIcon, Inventory as InventoryIcon, AttachMoney as PriceIcon, ExpandMore as ExpandMoreIcon, ShoppingCart as ProductIcon, LocalOffer as OfferIcon, TrendingUp as TrendingIcon, Warning as WarningIcon, CheckCircle as CheckIcon, Error as ErrorIcon, Info as InfoIcon} from '@mui/icons-material';;
...
const [produkte, setProdukte] = useState<Produkt[]>([
    {
      id: '1', name: 'Industrie-Schraube M8x20', artikelnummer: 'SCHR-001', kategorie: 'Befestigungselemente', beschreibung: 'Edelstahl-Schraube für industrielle Anwendungen', preis: 0.85, mwst: 19, lagerbestand: 1250, mindestbestand: 100, einheit: 'Stück', hersteller: 'Schrauben GmbH', status: 'aktiv', gewicht: 0.012, dimensionen: 'M8x20mm', ean: '4001234567890', erstelltAm: '2024-01-15', geaendertAm: '2024-01-20'
    }, {
      id: '2', name: 'Aluminium-Profil 40x40', artikelnummer: 'PROF-002', kategorie: 'Profile', beschreibung: 'Aluminium-Profil für Maschinenbau', preis: 12.50, mwst: 19, lagerbestand: 45, mindestbestand: 20, einheit: 'Meter', hersteller: 'AluTech AG', status: 'aktiv', gewicht: 1.2, dimensionen: '40x40mm', ean: '4001234567891', erstelltAm: '2024-01-10', geaendertAm: '2024-01-18'
    }, {
      id: '3', name: 'Sicherheits-Schalter', artikelnummer: 'SCHALT-003', kategorie: 'Elektronik', beschreibung: 'Not-Aus-Schalter mit Sicherheitsfunktion', preis: 89.90, mwst: 19, lagerbestand: 8, mindestbestand: 10, einheit: 'Stück', hersteller: 'ElektroSafe', status: 'aktiv', gewicht: 0.5, dimensionen: '80x60x30mm', ean: '4001234567892', erstelltAm: '2024-01-05', geaendertAm: '2024-01-15'
    }
  ]);;
const [kategorien, setKategorien] = useState<Kategorie[]>([
    {
      id: '1', name: 'Befestigungselemente', beschreibung: 'Schrauben, Muttern, Unterlegscheiben', produktAnzahl: 45
    }, {
      id: '2', name: 'Profile', beschreibung: 'Aluminium- und Stahlprofile', produktAnzahl: 23
    }, {
      id: '3', name: 'Elektronik', beschreibung: 'Schalter, Sensoren, Steuerungen', produktAnzahl: 67
    }, {
      id: '4', name: 'Werkzeuge', beschreibung: 'Hand- und Elektrowerkzeuge', produktAnzahl: 34
    }
  ]);;
const [lagerbestand, setLagerbestand] = useState<Lagerbestand[]>([
    {
      produktId: '1', produktName: 'Industrie-Schraube M8x20', aktuellerBestand: 1250, mindestbestand: 100, reserviert: 50, verfuegbar: 1200, letzteBewegung: '2024-01-20', status: 'normal'
    }, {
      produktId: '2', produktName: 'Aluminium-Profil 40x40', aktuellerBestand: 45, mindestbestand: 20, reserviert: 5, verfuegbar: 40, letzteBewegung: '2024-01-19', status: 'normal'
    }, {
      produktId: '3', produktName: 'Sicherheits-Schalter', aktuellerBestand: 8, mindestbestand: 10, reserviert: 2, verfuegbar: 6, letzteBewegung: '2024-01-18', status: 'kritisch'
    }
  ]);;
const [preise, setPreise] = useState<Preis[]>([
    {
      produktId: '1', produktName: 'Industrie-Schraube M8x20', listenpreis: 1.00, verkaufspreis: 0.85, rabatt: 15, mwst: 19, waehrung: 'EUR', gueltigAb: '2024-01-01'
    }, {
      produktId: '2', produktName: 'Aluminium-Profil 40x40', listenpreis: 15.00, verkaufspreis: 12.50, rabatt: 17, mwst: 19, waehrung: 'EUR', gueltigAb: '2024-01-01'
    }, {
      produktId: '3', produktName: 'Sicherheits-Schalter', listenpreis: 99.90, verkaufspreis: 89.90, rabatt: 10, mwst: 19, waehrung: 'EUR', gueltigAb: '2024-01-01'
    }
  ]);;
const [produktForm, setProduktForm] = useState<Partial<Produkt>>({
    name: '', artikelnummer: '', kategorie: '', beschreibung: '', preis: 0, mwst: 19, lagerbestand: 0, mindestbestand: 0, einheit: 'Stück', hersteller: '', status: 'aktiv', gewicht: 0, dimensionen: '', ean: ''
  });;
...
const handleSaveProdukt = () => {
    if (selectedProdukt) {
      ...
      setProdukte(produkte.map(p =>, p.id === selectedProdukt.id, ? { ...produktForm, id: p.id, geaendertAm: new Date().toISOString().split('T')[0] } as Produkt
          : p
      ));
      setSnackbar({
        open: true, message: 'Produkt erfolgreich aktualisiert', severity: 'success'
      });
    } else {
      // Create new product,;
const newProdukt: Produkt = {
      ...
      setSnackbar({
        open: true, message: 'Produkt erfolgreich erstellt', severity: 'success'
      });
    }
    handleCloseDialog();
  };;
const handleDeleteProdukt = (id: string) => {
    ...
    setSnackbar({
      open: true, message: 'Produkt erfolgreich gelöscht', severity: 'success'
    });
  };;
