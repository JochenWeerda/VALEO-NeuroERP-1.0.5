...
import {
  Card, CardContent, Typography, Box, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Chip, Alert, CircularProgress, Button, Dialog, DialogTitle, DialogContent, DialogActions, List, ListItem, ListItemText, ListItemIcon, Divider, Accordion, AccordionSummary, AccordionDetails} from '@mui/material';
import {
  Security as SecurityIcon, Warning as WarningIcon, Error as ErrorIcon, Info as InfoIcon, CheckCircle as CheckCircleIcon, ExpandMore as ExpandMoreIcon, Timeline as TimelineIcon, Assessment as AssessmentIcon, BugReport as BugReportIcon, Shield as ShieldIcon} from '@mui/icons-material';
...
export const SecurityReport: React.FC<SecurityReportProps> = ({
  timeRange = '24h', showDetails = true, refreshInterval = 30, }) => {;
...
variant="outlined"
      ...
      {/* Metriken */, }
      {metrics && (, <Grid container spacing={3, } mb={3, }>
      ...
      {metrics && (metrics.securityViolations > 0 || metrics.xssAttempts > 0 || metrics.sqlInjectionAttempts > 0) && (<Alert severity="warning" sx={{ mb: 3 }}>
          ...
          <ul>
            {metrics.securityViolations > 0 && (, <li>{metrics.securityViolations, } Sicherheitsverletzungen erkannt</li>)}
      ...
      {/* Ereignisliste */,}
      {showDetails && (<Card>, <CardContent>, <Box display="flex" alignItems="center" gap={1, } mb={2, }>
...
variant="outlined"
      ...
      >
        ...
        <DialogContent>
          {selectedEvent && (<Box>, <Typography variant="h6" gutterBottom>, {selectedEvent.description, }
              </Typography>
