...
interface ApiContextType {
  ...
  login: (credentials: _LoginRequest) => Promise<ApiResponse<LoginResponse>>;
  ...
  // API Methods,
  getTransactions: (params?: _any) => Promise<ApiResponse<Transaction[]>>;
  createTransaction: (transaction: Omit<_Transaction, 'id'>) => Promise<ApiResponse<Transaction>>;
  getInventory: (params?: _any) => Promise<ApiResponse<InventoryItem[]>>;
  createInventoryItem: (item: Omit<_InventoryItem, 'id'>) => Promise<ApiResponse<InventoryItem>>;
  updateInventoryItem: (id: _string, item: Partial<InventoryItem>) => Promise<ApiResponse<InventoryItem>>;
  getDocuments: (params?: _any) => Promise<ApiResponse<Document[]>>;
  uploadDocument: (file: _File, metadata: Partial<Document>) => Promise<ApiResponse<Document>>;
  getReports: (params?: _any) => Promise<ApiResponse<Report[]>>;
  createReport: (report: Omit<_Report, 'id' | 'created_at'>) => Promise<ApiResponse<Report>>;
  getNotifications: () => Promise<ApiResponse<Notification[]>>;
  markNotificationRead: (id: _string) => Promise<ApiResponse>;

  // Middleware,
  middlewareHealthCheck: () => Promise<ApiResponse>;
  getMiddlewareData: (endpoint: _string, params?: _any) => Promise<ApiResponse>;
}
...
const getTransactions = async (params?: unknown): Promise<ApiResponse<Transaction[]>> => {
    try {
      // Mock-Implementierung,;
const mockTransactions: Transaction[] = [
        {
...
const getInventory = async (params?: unknown): Promise<ApiResponse<InventoryItem[]>> => {
    try {
      // Mock-Implementierung,;
const mockInventory: InventoryItem[] = [
        {
...
const getDocuments = async (params?: unknown): Promise<ApiResponse<Document[]>> => {
    try {
      // Mock-Implementierung,;
const mockDocuments: Document[] = [
        {
...
const getReports = async (params?: unknown): Promise<ApiResponse<Report[]>> => {
    try {
      // Mock-Implementierung,;
const mockReports: Report[] = [
        {
...
const getMiddlewareData = async (endpoint: string, params?: unknown): Promise<ApiResponse> => {
    try {
      // Mock-Implementierung,
