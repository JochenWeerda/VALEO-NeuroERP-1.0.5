...
Revision ID: 8aacdc96b4fe
Revises: 
Create Date: 2025-05-21 15:02:24.650011
...
def upgrade() -> None:
    ...
    sa.Column('erstelltam', sa.DateTime(), nullable=True),
    sa.Column('status', sa.String(), nullable=True),
    ...
    sa.Column('status', sa.String(), nullable=True),
    sa.Column('pickliste_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('auftrag_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
